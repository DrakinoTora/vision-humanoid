...
//#define focalLength 651.429  //ini buat 90 derajat

// #define GABRIEL_DEBUG


   
#define focalLength 1311.43
#define realDiameter 14
    ...
    for(size_t i = 0; i < contours.size(); i++){
        ...
        if(contour_area > MIN_CONTOUR_AREA){
           ...
           // cv::rectangle(output_view,rect_rough_roi,cv::Scalar(255,255,255),2);
            ...
            //baru v13
            //double diameterPixel = rect_rough_roi.tl() - rect_rough_roi.tr();
...
//            std::cout << " Cost : " << circle_param[3] << std::endl;
        ...
        //  
                ...
                double diameterPixel = rect_rough_roi.width;
                std::cout << diameterPixel;
                ...
                //baru v13
                // float jarakAsli = 120;
                // focalLength = (jarakAsli*diameterPixel_filt)/realDiameter;
